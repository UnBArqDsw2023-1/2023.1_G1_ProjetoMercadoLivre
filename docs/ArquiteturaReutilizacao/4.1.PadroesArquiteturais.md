...
1 - What(O que?) - Aplicação e-commerce .

2 - Why(Por quê?) - Os e-commerce estão cada vez mais populares por facilitarem a vida das pessoas deixando tudo mais pratico com produtos ao alcance e ao mesmo tempo suprindo a grande demanda.

3 - Who(Quem?) - O time é composto essencialmente por estudantes de engenharia de software do campus gama seguindo o modelo organizacional adotado e os papeis propostos a cada membro da equipe.

4 - When (Quando?) - Seguindo a demanda de compras dos clientes cadastrados na plataforma diariamente.

5 - Where (Onde?) - Sera desenvolvida uma proposta no formato website.

1 - How (Como sera feito?) - Será desenvolvido em 3 modulos front-end que é responsavel pela interação com o usuário, o back-end que é responsável por gerenciar solicitações e inserir as regras de negocio e por último temos o banco de dados que utiliza o modelo relacional responsavel para armazenar informações geradas e coletadas durante os processos.

2 - How Much (Quanto custará) - Em estimativa:
    -  Custos com pesquisa e análise de mercado: R$ 3.000
    -  Custos com desenvolvimento e implementação da estrategia de vendas: R$ 5.000
    - Custos com marketing e promoção: R$ 8.000
    - Custos com otimização de processos de venda e logistica: R$ 4.000
    - Custos totais estimados: R$ 20.000
