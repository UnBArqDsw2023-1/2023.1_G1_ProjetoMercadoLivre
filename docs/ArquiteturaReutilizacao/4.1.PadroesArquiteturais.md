...
<figcaption align="center" >Figura - Represetnção Arquitetural. Fonte: Júlio César </figcaption>
...
- Extensibilidade: A partir da utilização de padrões de projeto e reutilização de código, a aplicação pode ser facilmente modificada para atender novos requisitos ou funcionalidades adicionais no futuro.
...
| 10.0   | 29/06 | Atualizando visão de casos de uso | Giulia e Guilherme |
| 11.0   | 30/06 | Adição dos tópicos: Tamanho e Performance e Qualidade | Bruna |