...
| Eric  | Colaborações no GRASP Alta Coesão | Excelente |
...
| Julio  | Colaborações no GRASP Alta Coesão | Excelente |
...
| Eric  | Auxílio na modelagem e na implementação do padrão Strategy + Singleton | Excelente |
...
| Julio  | Auxílio na modelagem e na implementação do padrão Strategy + Singleton | Excelente |
