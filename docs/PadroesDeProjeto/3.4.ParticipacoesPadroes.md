...
| -- | -- | -- |
| Ana Júlia  | Colaborações no GRASP Alta Coesão | Ruim |
...
|Nome do Membro | Contribuição | Significância da Contribuição para o Projeto (Excelente/Boa/Regular/Ruim/Nula) |
| -- | -- | -- |
| Ana Júlia  | Auxílio na implementação do padrão Strategy + Singleton | Ruim |
...
|Nome do Membro | Contribuição | Significância da Contribuição para o Projeto (Excelente/Boa/Regular/Ruim/Nula) |
| -- | -- | -- |
| Ana Júlia  | Auxílio no estudo dos padrões emergentes | Ruim |
