 ...
 * Por fim com as entregas prontas nos reunimos novamente para revisar e propor melhorias que após aplicadas facilitou a definição da documentação de todos os diagramas de sequência desenvolvidos
 </p>
