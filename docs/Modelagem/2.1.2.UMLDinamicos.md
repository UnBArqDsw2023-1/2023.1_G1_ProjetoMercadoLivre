...
<p align="justify">
Com as equipe definida anteriormente foi possível organizar uma reunião onde trocamos ideias e definimos o nível de conhecimento para estabelecer o estudo em grupo, avaliamos as facilidades e interesses individuais para o direcionamento das tarefas a serem feitas, durante todo o período de desenvolvimento usamos um grupo do whatsapp para esclarecimento de dúvidas e ao final nos reunimos para conferir os resultados obtidos</p>
