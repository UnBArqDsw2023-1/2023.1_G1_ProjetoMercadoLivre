...
* Utilizamos uma ata para organizarmos o que foi decidido por mensagens
...
* O Eric teve alguns imprevistos e não conseguiu comparecer a aula nesse dia, então assim que a Ana Júlia mencionou que os diagramas já estavam finalizados, o Eric prontamente se fez livre para realizar a documentação desses diagramas.
* Uma vez que a documentação estava pronta, o Wengel verificou se estava tudo correto. E finalizamos a entrega
* Durante a aula de apresentação no dia 15/05, os três executores estavam presentes na aula e juntos fizeram anotações do que poderiam melhorar na documentação e executaram essas melhorias de acordo com os feedbacks dados pela professora aos outros grupos.</p>
